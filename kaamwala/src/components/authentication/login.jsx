...
import LandingLogo from "../../assets/images/logo-color.svg";
  ...
  return (
    <section className="flex justify-center items-center bg-[#ECEFF3] w-full min-h-screen font-montserrat">
      <div className="flex flex-col rounded-md bg-[#ffffff] sm:w-[25rem] sm:h-[40rem] md:w-[30rem] md:h-[43rem] pb-10 sm:rounded-md md:rounded-md lg:rounded-tr-md lg:rounded-br-md lg:rounded-tl-none lg:rounded-bl-none">
        ...
        >
          <label htmlFor="" className="text-[#4067d1] font-medium mb-3">
            Username or Email
          </label>
          <input
            type="email"
          ...
          />
          <label htmlFor="" className="text-[#4969d2] font-medium mb-3">
            Password
          </label>
          ...
          <div className="text-[#777575] tracking-widest outline-0 border-[0.05rem] border-[#9F9F9F] focus:border-[#0C61FE] focus:border-[0.07rem] mb-5 text-[14px] py-2 px-3 rounded-md">
            <input
              type="password"
              id="password"
              name="password"
          ...
          <Link
            to="/recovery"
            className="flex text-[#f24545] items-center text-sm hover:cursor-pointer hover:underline w-fit"
          >
            Forgot Password?
          </Link>
          <button
          ...
          <p className="flex justify-center items-center mt-10 text-[#9F9F9F] text-sm gap-2">
            New to Kaam-Wala?{" "}
            <Link to="/signup">
              <span className="text-[#f34444] hover:underline hover:cursor-pointer">
                Create Account
              </span>{" "}
            </Link>
          </p>
